...
func (_m *MockAdapter) CanTrade() (bool, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for CanTrade")
	}
...
func (_c *MockAdapter_CanTrade_Call) RunAndReturn(run func() (bool, error)) *MockAdapter_CanTrade_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockAdapter) CancelPairOrder(pairSymbol string, orderID int64, ctx context.Context) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for CancelPairOrder")
	}
...
func (_c *MockAdapter_CancelPairOrder_Call) RunAndReturn(run func(string, int64, context.Context) error) *MockAdapter_CancelPairOrder_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockAdapter) CancelPairOrderByClientOrderID(pairSymbol string, clientOrderID string, ctx context.Context) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for CancelPairOrderByClientOrderID")
	}
...
func (_c *MockAdapter_CancelPairOrderByClientOrderID_Call) RunAndReturn(run func(string, string, context.Context) error) *MockAdapter_CancelPairOrderByClientOrderID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockAdapter_Connect_Call) RunAndReturn(run func(structs.APICredentials) error) *MockAdapter_Connect_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockAdapter) GetCandleWorker() workers.ICandleWorker {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetCandleWorker")
	}
...
func (_c *MockAdapter_GetCandleWorker_Call) RunAndReturn(run func() workers.ICandleWorker) *MockAdapter_GetCandleWorker_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockAdapter) GetCandles(limit int, symbol string, interval string) ([]workers.CandleData, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(int, string, string) ([]workers.CandleData, error)); ok {
		return rf(limit, symbol, interval)
	}
...
func (_c *MockAdapter_GetCandles_Call) RunAndReturn(run func(int, string, string) ([]workers.CandleData, error)) *MockAdapter_GetCandles_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockAdapter_GetID_Call) RunAndReturn(run func() int) *MockAdapter_GetID_Call {
	_c.Call.Return(run)
	return _c
}

// GetLimits provides a mock function with given fields:
func (_m *MockAdapter) GetLimits() structs.ExchangeLimits {
	ret := _m.Called()
	...
	var r0 structs.ExchangeLimits
	if rf, ok := ret.Get(0).(func() structs.ExchangeLimits); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(structs.ExchangeLimits)
	}

	return r0
}

// MockAdapter_GetLimits_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetLimits'
type MockAdapter_GetLimits_Call struct {
	*mock.Call
}

// GetLimits is a helper method to define mock.On call
func (_e *MockAdapter_Expecter) GetLimits() *MockAdapter_GetLimits_Call {
	return &MockAdapter_GetLimits_Call{Call: _e.mock.On("GetLimits")}
}

func (_c *MockAdapter_GetLimits_Call) Run(run func()) *MockAdapter_GetLimits_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockAdapter_GetLimits_Call) Return(_a0 structs.ExchangeLimits) *MockAdapter_GetLimits_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAdapter_GetLimits_Call) RunAndReturn(run func() structs.ExchangeLimits) *MockAdapter_GetLimits_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockAdapter_GetName_Call) RunAndReturn(run func() string) *MockAdapter_GetName_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockAdapter) GetOrderByClientOrderID(pairSymbol string, clientOrderID string) (internalstructs.OrderData, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetOrderByClientOrderID")
	}

	var r0 internalstructs.OrderData
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string) (internalstructs.OrderData, error)); ok {
		return rf(pairSymbol, clientOrderID)
	}
...
func (_c *MockAdapter_GetOrderByClientOrderID_Call) RunAndReturn(run func(string, string) (internalstructs.OrderData, error)) *MockAdapter_GetOrderByClientOrderID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockAdapter) GetOrderData(pairSymbol string, orderID int64) (internalstructs.OrderData, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetOrderData")
	}

	var r0 internalstructs.OrderData
	var r1 error
	if rf, ok := ret.Get(0).(func(string, int64) (internalstructs.OrderData, error)); ok {
...
func (_c *MockAdapter_GetOrderData_Call) RunAndReturn(run func(string, int64) (internalstructs.OrderData, error)) *MockAdapter_GetOrderData_Call {
	_c.Call.Return(run)
	return _c
}

// GetOrderExecFee provides a mock function with given fields: baseAssetTicker, quoteAssetTicker, orderSide, orderID
func (_m *MockAdapter) GetOrderExecFee(baseAssetTicker string, quoteAssetTicker string, orderSide consts.OrderSide, orderID int64) (internalstructs.OrderFees, error) {
	ret := _m.Called(baseAssetTicker, quoteAssetTicker, orderSide, orderID)

	if len(ret) == 0 {
		panic("no return value specified for GetOrderExecFee")
	}

	var r0 internalstructs.OrderFees
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, consts.OrderSide, int64) (internalstructs.OrderFees, error)); ok {
		return rf(baseAssetTicker, quoteAssetTicker, orderSide, orderID)
	}
	if rf, ok := ret.Get(0).(func(string, string, consts.OrderSide, int64) internalstructs.OrderFees); ok {
		r0 = rf(baseAssetTicker, quoteAssetTicker, orderSide, orderID)
	} else {
		r0 = ret.Get(0).(internalstructs.OrderFees)
	}

	if rf, ok := ret.Get(1).(func(string, string, consts.OrderSide, int64) error); ok {
...
func (_c *MockAdapter_GetOrderExecFee_Call) Run(run func(baseAssetTicker string, quoteAssetTicker string, orderSide consts.OrderSide, orderID int64)) *MockAdapter_GetOrderExecFee_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string), args[2].(consts.OrderSide), args[3].(int64))
	})
	return _c
}
...
func (_c *MockAdapter_GetOrderExecFee_Call) RunAndReturn(run func(string, string, consts.OrderSide, int64) (internalstructs.OrderFees, error)) *MockAdapter_GetOrderExecFee_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockAdapter) GetPairBalance(pair internalstructs.PairSymbolData) (internalstructs.PairBalance, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetPairBalance")
	}

	var r0 internalstructs.PairBalance
	var r1 error
	if rf, ok := ret.Get(0).(func(internalstructs.PairSymbolData) (internalstructs.PairBalance, error)); ok {
		return rf(pair)
	}
...
func (_c *MockAdapter_GetPairBalance_Call) RunAndReturn(run func(internalstructs.PairSymbolData) (internalstructs.PairBalance, error)) *MockAdapter_GetPairBalance_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockAdapter) GetPairData(pairSymbol string) (internalstructs.ExchangePairData, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetPairData")
	}

	var r0 internalstructs.ExchangePairData
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (internalstructs.ExchangePairData, error)); ok {
		return rf(pairSymbol)
	}
...
func (_c *MockAdapter_GetPairData_Call) RunAndReturn(run func(string) (internalstructs.ExchangePairData, error)) *MockAdapter_GetPairData_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockAdapter) GetPairLastPrice(pairSymbol string) (float64, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetPairLastPrice")
	}
...
func (_c *MockAdapter_GetPairLastPrice_Call) RunAndReturn(run func(string) (float64, error)) *MockAdapter_GetPairLastPrice_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockAdapter) GetPairOpenOrders(pairSymbol string) ([]internalstructs.OrderData, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetPairOpenOrders")
	}

	var r0 []internalstructs.OrderData
	var r1 error
	if rf, ok := ret.Get(0).(func(string) ([]internalstructs.OrderData, error)); ok {
		return rf(pairSymbol)
	}
...
func (_m *MockAdapter) GetPairs() ([]internalstructs.ExchangePairData, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetPairs")
	}

	var r0 []internalstructs.ExchangePairData
	var r1 error
	if rf, ok := ret.Get(0).(func() ([]internalstructs.ExchangePairData, error)); ok {
		return rf()
	}
...
func (_c *MockAdapter_GetPairs_Call) RunAndReturn(run func() ([]internalstructs.ExchangePairData, error)) *MockAdapter_GetPairs_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockAdapter) GetPriceWorker(callback workers.PriceEventCallback) workers.IPriceWorker {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetPriceWorker")
	}
...
func (_c *MockAdapter_GetTag_Call) RunAndReturn(run func() string) *MockAdapter_GetTag_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockAdapter) GetTradeEventsWorker() workers.ITradeEventWorker {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetTradeEventsWorker")
	}
...
func (_c *MockAdapter_GetTradeEventsWorker_Call) RunAndReturn(run func() workers.ITradeEventWorker) *MockAdapter_GetTradeEventsWorker_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockAdapter) PlaceOrder(ctx context.Context, order internalstructs.BotOrderAdjusted) (internalstructs.CreateOrderResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, internalstructs.BotOrderAdjusted) (internalstructs.CreateOrderResponse, error)); ok {
		return rf(ctx, order)
	}
...
func (_c *MockAdapter_PlaceOrder_Call) RunAndReturn(run func(context.Context, internalstructs.BotOrderAdjusted) (internalstructs.CreateOrderResponse, error)) *MockAdapter_PlaceOrder_Call {
	_c.Call.Return(run)
	return _c
}
