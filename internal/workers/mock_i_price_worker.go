...
func (_m *MockIPriceWorker) SubscribeToPriceEvents(pairSymbols []string, eventCallback PriceEventCallback, errorHandler func(error)) (map[string]WorkerChannels, error) {
	ret := _m.Called(pairSymbols, eventCallback, errorHandler)

	var r0 map[string]WorkerChannels
	if rf, ok := ret.Get(0).(func([]string, PriceEventCallback, func(error)) map[string]WorkerChannels); ok {
		r0 = rf(pairSymbols, eventCallback, errorHandler)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[string]WorkerChannels)
		}
	}
...
func (_c *MockIPriceWorker_SubscribeToPriceEvents_Call) Return(_a0 map[string]WorkerChannels, _a1 error) *MockIPriceWorker_SubscribeToPriceEvents_Call {
