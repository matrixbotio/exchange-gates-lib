...
type mockConstructorTestingTNewMockTradeEventCallback interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockTradeEventCallback(t mockConstructorTestingTNewMockTradeEventCallback) *MockTradeEventCallback {
