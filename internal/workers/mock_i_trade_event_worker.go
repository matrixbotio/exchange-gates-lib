...
func (_c *MockITradeEventWorker_GetExchangeTag_Call) RunAndReturn(run func() string) *MockITradeEventWorker_GetExchangeTag_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockITradeEventWorker_Stop_Call) RunAndReturn(run func()) *MockITradeEventWorker_Stop_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockITradeEventWorker_SubscribeToTradeEventsPrivate_Call) RunAndReturn(run func(TradeEventPrivateCallback, func(error)) error) *MockITradeEventWorker_SubscribeToTradeEventsPrivate_Call {
	_c.Call.Return(run)
	return _c
}
...
func NewMockITradeEventWorker(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockITradeEventWorker {
